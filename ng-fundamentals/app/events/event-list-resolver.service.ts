...
export class EventListResolverService implements Resolve<any>{
    ...
    resolve(): Observable<IEvent[]> {
        ...
        // this will return the data to resolve: { events: EventListResolverService }, 
        // -- in route.ts, then from there it passed to the route and is accessible in the component
